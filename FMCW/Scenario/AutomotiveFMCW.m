...
for k = 1:NInterference
    disp('Iterazione ')
    disp(k)
    [yi,xi] = echoInterferenceFMCW(x,Pt,n,di,vi,fc,fc,fs,B,B,NT,NTsw,NT*Ts,NTsw*Ts,M,M,0);
